...
fn hline_path(world: &mut World, x1: u32, x2: u32, y: u32) {
    ...
    for x in a..=b {
        world.set_ground(x, y, GroundTile::Path);
    }
}
...
pub fn create_default_town() -> World {
    ...
    world.add_building(Building {
        id: "house-maya".into(),
        name: "Maya's Cottage".into(),
        building_type: OverlayTile::House,
        x: maya_x,
        y: maya_y,
        width: 1,
        height: 2,
        owner: Some("Content-Maya".into()),
    ...
    // Fence yard
    for dx in 0..5 {
        world.set_overlay(maya_x - 1 + dx, maya_y + 3, OverlayTile::Fence);
    }
    ...
    world.add_building(Building {
        id: "house-alex".into(),
        name: "Alex's Study".into(),
        building_type: OverlayTile::House,
        x: alex_x,
        y: alex_y,
        width: 1,
        height: 2,
        owner: Some("Data-Alex".into()),
        team_color: TeamColor::Cyan,
        sprite_variant: 1,
    });
    world.set_overlay(alex_x - 1, alex_y, OverlayTile::Bush);
    world.set_overlay(alex_x + 1, alex_y, OverlayTile::Bush);
    for dx in 0..5 {
        world.set_overlay(alex_x - 1 + dx, alex_y + 3, OverlayTile::Fence);
    }
    ...
    world.add_building(Building {
        id: "house-sarah".into(),
        name: "Sarah's Home".into(),
        building_type: OverlayTile::House,
        x: sarah_x,
        y: sarah_y,
        width: 1,
        height: 2,
        owner: Some("Support-Sarah".into()),
        team_color: TeamColor::Lime,
        sprite_variant: 2,
    });
    ...
    world.add_building(Building {
        id: "house-marcus".into(),
        name: "Marcus's Lodge".into(),
        building_type: OverlayTile::House,
        x: marcus_x,
        y: marcus_y,
        width: 1,
        height: 2,
        owner: Some("Ads-Marcus".into()),
    ...
    world.add_building(Building {
        id: "house-iris".into(),
        name: "Iris's Quarters".into(),
        building_type: OverlayTile::House,
        x: iris_x,
        y: iris_y,
        width: 1,
        height: 2,
        owner: Some("Research-Iris".into()),
        team_color: TeamColor::Purple,
        sprite_variant: 1,
    });
    ...
    world.add_building(Building {
        id: "house-kai".into(),
        name: "Kai's Workshop".into(),
        building_type: OverlayTile::House,
        x: kai_x,
        y: kai_y,
        width: 1,
        height: 2,
        owner: Some("Engineer-Kai".into()),
        team_color: TeamColor::Cyan,
        sprite_variant: 2,
    });
    ...
    world.add_building(Building {
        id: "house-willow".into(),
        name: "Willow's Greenhouse".into(),
        building_type: OverlayTile::House,
        x: willow_x,
        y: willow_y,
        width: 1,
        height: 2,
        owner: Some("Gardener-Willow".into()),
        team_color: TeamColor::Lime,
        sprite_variant: 0,
    });
    ...
    world.add_building(Building {
        id: "academy-keep".into(),
        name: "The Academy".into(),
    ...
    // Chapel (library)
    world.add_building(Building {
        id: "academy-chapel".into(),
        name: "Library of Wisdom".into(),
    ...
    // Workshop 2
    world.add_building(Building {
        id: "forge-workshop2".into(),
        name: "Tinkerer's Shop".into(),
        building_type: OverlayTile::Workshop,
        x: fg_x + 8,
        y: fg_y + 3,
        width: 1,
            ...
            if let Some(tile) = world.get_tile(x, y) {
                ...
                .any(|&(nx, ny)| {
                    if nx < W && ny < H {
                        world
                            .get_tile(nx, ny)
                            .is_some_and(|t| t.ground == GroundTile::Water)
                    } else {
                        false
                    }
                });
    ...
    let south_nature: Vec<(u32, u32, OverlayTile)> = vec![
        (55, 65, OverlayTile::TreeOak),
        (58, 68, OverlayTile::TreePine),
        (60, 63, OverlayTile::Rock),
        (63, 66, OverlayTile::TreeOak),
        (65, 70, OverlayTile::RockSmall),
        (25, 75, OverlayTile::TreePine),
        (28, 72, OverlayTile::TreeOak),
        (20, 70, OverlayTile::Bush),
        (35, 75, OverlayTile::Flowers),
        (40, 77, OverlayTile::TreeOak),
        (68, 75, OverlayTile::TreePine),
        (70, 72, OverlayTile::Rock),
    ];
