...
impl App {
    ...
    /// Uses the full TrainingRunner with meta-learning and DB integration
    fn start_background_training(&mut self) {
        ...
        // Use the TrainingRunner's new TUI-aware training method
        self.training_runner.start_training_with_tui(snapshot, running);
    }
