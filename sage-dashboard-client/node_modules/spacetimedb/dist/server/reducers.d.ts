...
import type { InferTypeOfRow, RowBuilder, RowObj, TypeBuilder } from './type_builders';
/**
 ...
 */
type ParamsAsObject<ParamDef extends ParamsObj | RowObj> = InferTypeOfRow<ParamDef>;
/**
 ...
 * ```
 */
export type Reducer<S extends UntypedSchemaDef, Params extends ParamsObj | RowObj> = (ctx: ReducerCtx<S>, payload: ParamsAsObject<Params>) => void | {
    tag: 'ok';
} | {
    tag: 'err';
    value: string;
 ...
 */
export declare function pushReducer(name: string, params: RowObj | RowBuilder<RowObj>, fn: Reducer<any, any>, lifecycle?: RawReducerDefV9['lifecycle']): void;
export declare const REDUCERS: Reducer<any, any>[];
/**
 * Defines a SpacetimeDB reducer function.
 *
 * Reducers are the primary way to modify the state of your SpacetimeDB application.
 ...
 * ```
 */
export declare function reducer<S extends UntypedSchemaDef, Params extends ParamsObj | RowObj>(name: string, params: Params, fn: (ctx: ReducerCtx<S>, payload: ParamsAsObject<Params>) => void): void;
/**
 ...
 * - `ctx`: The reducer context, providing access to `sender`, `timestamp`, `connection_id`, and `db`.
 */
export declare function init<S extends UntypedSchemaDef, Params extends ParamsObj>(name: string, params: Params, fn: Reducer<S, Params>): void;
/**
 ...
 */
export declare function clientConnected<S extends UntypedSchemaDef, Params extends ParamsObj>(name: string, params: Params, fn: Reducer<S, Params>): void;
/**
 ...
 * ```
 */
export declare function clientDisconnected<S extends UntypedSchemaDef, Params extends ParamsObj>(name: string, params: Params, fn: Reducer<S, Params>): void;
export {};
