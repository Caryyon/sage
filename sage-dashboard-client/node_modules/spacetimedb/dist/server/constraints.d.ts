 ...
 */
export type AllUnique<TableDef extends UntypedTableDef, Columns extends ReadonlyArray<keyof TableDef['columns']>> = Columns extends readonly [
    infer Head extends keyof TableDef['columns'],
    ...infer Tail extends ReadonlyArray<keyof TableDef['columns']>
] ? ColumnIsUnique<TableDef['columns'][Head]['columnMetadata']> extends true ? AllUnique<TableDef, Tail> : false : true;
/**
