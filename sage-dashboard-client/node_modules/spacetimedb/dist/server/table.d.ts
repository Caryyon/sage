 ...
 */
export type RowType<TableDef extends UntypedTableDef> = InferTypeOfRow<TableDef['columns']>;
/**
 * Coerces a column which may be a TypeBuilder or ColumnBuilder into a ColumnBuilder
 */
export type CoerceColumn<Col extends TypeBuilder<any, any> | ColumnBuilder<any, any, any>> = Col extends TypeBuilder<infer T, infer U> ? ColumnBuilder<T, U, object> : Col;
/**
 ...
 */
export type TableSchema<TableName extends string, Row extends Record<string, ColumnBuilder<any, any, any>>, Idx extends readonly IndexOpts<keyof Row & string>[]> = {
